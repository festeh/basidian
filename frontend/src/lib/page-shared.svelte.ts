...
export function createPageState() {
  ...
  return {
    get showCreateFileModal() {
      return showCreateFileModal;
    },
    set showCreateFileModal(v: boolean) {
      showCreateFileModal = v;
    },
    get showCreateFolderModal() {
      return showCreateFolderModal;
    },
    set showCreateFolderModal(v: boolean) {
      showCreateFolderModal = v;
    },
    get newItemName() {
      return newItemName;
    },
    set newItemName(v: string) {
      newItemName = v;
    },
    get isCreating() {
      return isCreating;
