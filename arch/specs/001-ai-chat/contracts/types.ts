 ...
 *
 * This file defines the contract for all data structures used by the AI Chat plugin.
 * These interfaces should be copied to the plugin's types.ts during implementation.
 */
...
/**
 * State for the chat pane component.
 */
...
export interface SettingsState {
  ...
  /** Result of last API key validation */
